---
title: 從 Obsidian vault 發佈的第一篇筆記
...
這篇筆記寫在樹梅派上的 Obsidian vault（`notes/從vault發佈的第一篇.md`，中文檔名），你現在看到它的網址卻是英文的 `/posts/hello-from-vault/`——因為 front matter 裡指定了 `slug`。
...
如果你看得到這篇文章和上面的圖，代表 M2 的核心管線已經打通。
